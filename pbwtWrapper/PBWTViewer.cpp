...
//
//
//int PBWTViewer::CursorForwards(Index2ID& MAP1,ID2POP& MAP2) {//so far only implemented for test purpose
//
//
//    //PrintVector(forwardCursor->a,M,"end arrary aFend check 0");
//
...
//int PBWTViewer::CursorForwardsTo(int k, int T, RESULT *result) {
...
//
//
//int PBWTViewer::CursorForwardsTo(int k, Index2ID &MAP1, ID2POP& MAP2, int T) {
///*T is the length that how far you look back
// *This function must be called along the sites, no skip permitted;
// *Mask the site you want to skip at the begining if you have to.
// */
